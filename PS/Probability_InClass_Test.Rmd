...
checkEvent1 = function(data){
  return(sum(grepl('A', data)) == 3) #match particular element
}
# which(grep1('A',x))-> returns position of Ace
```
...
checkEvent2 = function(data){
  ...
  condition2 = (length(unique(ceiling(which(grepl('A',data))/5))) == 4)#returns next integer
...
#15*choose(4,3)*choose(48,40)/choose(52,40)
```
